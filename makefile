...
mica_v0-21.o: mica.h mica_v0-21.cpp
	$(CXX) -g -c $(CXXFLAGS) $(PIN_CXXFLAGS) mica_v0-21.cpp -o mica_v0-21.o

mica_v0-21: mica.h mica_v0-21.o mica_all.o mica_init.o mica_utils.o mica_ilp.o mica_itypes.o mica_ppm.o mica_reg.o mica_stride.o mica_memfootprint.o mica_memreusedist.o
	$(CXX) -g $(PIN_LDFLAGS) $(LINK_DEBUG) mica_v0-21.o mica_all.o mica_init.o mica_utils.o mica_ilp.o mica_itypes.o mica_ppm.o mica_reg.o mica_stride.o mica_memfootprint.o mica_memreusedist.o -o mica_v0-21 $(PIN_LPATHS) $(PIN_LIBS) $(DBG)


clean: 
	rm -f *.o mica_v0-21 *pin*out mica*log*
